...
Default rate rises monotonically from Grade A to Grade E, and predicted
default rates track actual default rates closely across score deciles —
i.e., the model is both **discriminating** and **calibrated**.
